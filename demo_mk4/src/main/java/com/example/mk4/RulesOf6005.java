...
public class RulesOf6005 {
    ...
    boolean citingYourSource, boolean implementationRequired) {
        ...
        // If the code was written by yourself, it is allowed
        if (writtenByYourself) {
        return true;
        }

        // If the code is available to others and was written as coursework, and the source is cited, it's allowed
        if (availableToOthers && writtenAsCourseWork && citingYourSource) {
        return true;
        }

        // If the assignment specifically requires implementation and the conditions aren't met, throw an exception
    ...
    public static void main(String[] args) {
        try {
            // This will run the method and print the result if no exception is thrown
